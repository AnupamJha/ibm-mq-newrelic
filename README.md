...
The monitor connects to each queueManager that is specified in the plugin.json.


## Monitor requirements

1. Java Runtime version 1.8 or later
2. IBM WebSphere MQ v7 or later. 
...
The __agents__ object contains an array of __agent__ objects. Each agent object has the following properties.
